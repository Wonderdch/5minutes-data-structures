...
namespace P003SingleLinkedList
{
    class Program
    {
        ...
        {
            var linkedList = new MySingleLinkedList<int>();
            // Test1:顺序插入4个节点
            linkedList.Add(0);
            linkedList.Add(1);
            linkedList.Add(2);
            ...
            // Test2.3:在索引为6（即最后一个节点）的位置插入单个节点
            linkedList.Insert(6, 30);
            Console.WriteLine("After insert 30 in index of 6:");
            for (var i = 0; i < linkedList.Count; i++)
            {
                Console.WriteLine(linkedList[i]);
            }
            ...
            // Test3.1:移除索引为6（即最后一个节点）的节点
            linkedList.RemoveAt(6);
            Console.WriteLine("After remove an node in index of 6:");
            for (var i = 0; i < linkedList.Count; i++)
            {
                Console.WriteLine(linkedList[i]);
            }
